...
public class JwtRedisUtil {
    ...
    /**
     * 生成签名,并保存到redis中
     * @param userOnlyNo 用户唯一凭证(一般是登录名
     * @param map 其余数据
     * @return 签名
     */
    public static String sign(String userOnlyNo, Map<String, Object> map){
        ...
        // 用户自定义字段
        builder.withClaim(JwtConstant.TOKEN_KEY,userOnlyNo);
        if(map!=null){
