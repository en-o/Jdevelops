package cn.jdevelop.apilog.aspect;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import cn.jdevelop.apilog.annotation.ApiLog;
import cn.jdevelop.apilog.bean.ApiMonitoring;
import cn.jdevelop.apilog.server.ApiLogSave;
import cn.jdevelop.enums.string.StringEnum;
import cn.jdevelop.enums.time.TimeFormatEnum;
import cn.jdevelop.http.core.IpUtil;
import cn.jdevelop.spring.core.aop.AopReasolver;
...
public class ApiLogAspectSave {
     ...
     * 在注解的位置切入代码
     */
    @Pointcut("@annotation(cn.jdevelop.apilog.annotation.ApiLog)")
    public void apiLog() {
    }
