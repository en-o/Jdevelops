...
import cn.tannn.jdevelops.utils.core.system.EPlatform;
import cn.tannn.jdevelops.utils.core.system.OSinfo;
        ...
        try {
            ...
            if (null != macAddress && macAddress.trim().length() > 0) {
                ...
                if (JarConstant.JAR.equalsIgnoreCase(substring)) {
                    ...
                    jarAddFile.setFilesToAddRelativePath(OSinfo.win2Linux("BOOT-INF/classes/"));
