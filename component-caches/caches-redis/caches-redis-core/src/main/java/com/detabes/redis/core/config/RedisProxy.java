package com.detabes.redis.core.config;
...
public class RedisProxy {
     ...
     * @return 对应的多个键值
     */
    public List<Object> hgetMulti(String key, Collection<Object> items) {
     ...
     *
     *  CACHE_NAMES + "::" = key前缀
     *  List<String> scan = redisProxy.scan(template, CACHE_NAMES + "::" + "*", 200);
     *
     *
     *      for (String sx: scan) {
     *             Map<Object, Object> entries = template.opsForHash().entries(sx);
