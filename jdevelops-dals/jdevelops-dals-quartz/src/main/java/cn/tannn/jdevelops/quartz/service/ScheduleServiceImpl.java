...
//                    .usingJobData("data", data)
    ...
    @Override
    public void addScheduleJob(Class<? extends Job> jobBeanClass, String jName, String cron, boolean isStartNow) {
        addScheduleJob(jobBeanClass, jName, jName, jName, jName, cron, isStartNow);
    }
    ...
    public void addScheduleJob(Class<? extends Job> jobBeanClass,
        ...
        addScheduleJob(jobBeanClass, jName, jGroup, tName, tGroup, startCron, isStartNow);
    }
