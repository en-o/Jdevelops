...
public class EsBasicsUtil {
     ...
     * @date 2021/5/11 16:28
     */
    public static void setPageWindowIsTooLarge(SearchRequest.Builder builder, Paging page) {
        //设置分页参数
     ...
     * @date 2021/5/11 16:28
     */
    public static void setPage(SearchRequest.Builder builder, Paging page) {
        //设置分页参数
        int startIndex = page.getPageIndex() * page.getPageSize();
        builder.from(startIndex);
